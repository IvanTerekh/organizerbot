...
DELETE FROM AUTO_PK_SUPPORT WHERE TABLE_NAME IN ('LessonBean', 'Professors', 'Subject', 'Users')
;

INSERT INTO AUTO_PK_SUPPORT (TABLE_NAME, NEXT_ID) VALUES ('LessonBean', 200)
;
